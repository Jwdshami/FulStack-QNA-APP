...
import { commentsCollection, db } from "@/src/models/name";
...
const Comments = ({
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await databases.createDocument(db, commentsCollection, ID.unique(), {
                content: newComment,
                authorId: user.$id,
                type: type,
                typeId: typeId,
    ...
    const deleteComment = async (commentId: string) => {
        try {
            await databases.deleteDocument(db, commentsCollection, commentId);
